...
export function AboutPage() {
  return (
    <div className="h-full overflow-y-auto flex flex-col select-none animate-fade-up">
      <div className="p-4 flex flex-col gap-4 max-w-xl mx-auto w-full flex-1">
        <div>
          ...
          <div className="bg-surface rounded-lg border border-white/8 p-4 flex flex-col gap-2">
            ...
            <ul className="text-xs text-white/80 leading-relaxed list-disc list-inside flex flex-col gap-2.5">
              <li>
                ...
                Personas con discapacidad y de la tercera edad pagan tarifa preferencial de $7.75
                MXN (50% de descuento) y estudiantes $5.85 MXN al mostrar su credencial
                correspondiente. Algunas personas con discapacidad tienen acceso gratuito.
              </li>
              <li>
      ...
      {/* Footer */}
      <div className="w-full pt-6 border-t border-white/10 flex flex-col items-center gap-3 pb-8">
        <LegalLinks />
